---
title: "FA20 Spring Travel Ads"
subtitle: "FY19 Spring Travel Ads Recruiting HS students for Fall 2020"
...
* Facebook saw a big drop in CTR performance. In general, [FB Newsfeed CTR overall experienced a 24% drop from July, 2017 - July, 2018.](https://blog.adstage.io/facebook-ads-benchmarks) We felt such a drop required that we look into other digital advertising options, and therefore expanded our portfolio to include Instagram and LinkedIn in addition to DBM.

* We decreased our spend on FB display for the HS market, as we have seen a decline over time in CTR. This decline continued with this Spring Travel campaign. A decline in spending does not directly impact CTR. 
...
As a result of Facebook's waning CTR, we decreased our total spend with this vendor.
